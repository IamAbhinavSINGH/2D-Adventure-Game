...
public class CutSceneManager {
    ...
    public CutSceneManager(GamePanel gp){
        ...
        endCredit = "A small 2D game made by me(Abhinav Singh)"
                    + "\n\n\n\n\n\n\n\n\n\n\n"
                    + "Special Thanks\n"
                    + "Everyone that knows me\n"
                    + " ''' Thanks for Playing'''' \n"
                    + "\n\n\n\n\n"
                    + "IDK, what should I write in credits,\n"
                    + "But if you follow it till here then \n"
                    + "do me a favor find any bugs if u can \n"
                    + "and plz let me know";
    }
